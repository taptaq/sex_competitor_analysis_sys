...
const filePath = "/Users/taptaq/Documents/初心路/项目/情趣用品竞品分析系统/supabase/functions/ai-api/index.ts";

function updateFile() {
  try {
    let content = fs.readFileSync(filePath, 'utf8');

    // 1. Update Price Analysis Prompt
    ...
    // 2. Update Brand Characteristics Prompt
